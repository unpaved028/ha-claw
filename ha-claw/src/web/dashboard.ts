...
const TEMPLATE_LINES: string[] = [
  ...
  "                Backlog",
  "              </button>",
  "              <button class=\"settings-nav-item\" data-settings=\"health\">",
  "                <span class=\"settings-nav-icon\"",
  "                  ><svg",
  "                    width=\"16\"",
  "                    height=\"16\"",
  ...
  "                Konfiguriere HA-Claw Parameter, Tools und ueberwache den Systemstatus.",
  "              </p>",
  "            </div>",
  "",
  "            <!-- Model Forge -->",
  ...
  "",
  "            <!-- System Health -->",
  "            <div class=\"settings-section\" id=\"settings-health\">",
  "              <div class=\"backlog-header\">",
  "                <div class=\"settings-section-title\">Systemzustand</div>",
  ...
  "                Erreichbarkeit, tote Sensoren und Batterien sind Dauerzustaende und keine",
  "                Verbesserungsvorschlaege &ndash; sie stehen deshalb hier und nicht im Backlog.",
  "                Telegram meldet sich nur, wenn sich ein Wert verschlechtert.",
  "              </div>",
  "",
  "              <div class=\"health-list\" id=\"health-list\">",
  "                <div class=\"backlog-empty\">Lade Systemzustand...</div>",
  "              </div>",
  "",
  "              <div class=\"health-maintenance\">",
  "                <div class=\"backlog-detail-label\">Backlog aufraeumen</div>",
  "                <div class=\"health-maintenance-text\">",
  "                  Entfernt doppelte Analyse-Eintraege desselben Befunds sowie alte Eintraege der",
  "                  Pruefungen, die jetzt hier oben stehen. Von dir oder dem Agenten angelegte Tasks",
  "                  bleiben unberuehrt, ebenso deine Entscheidungen.",
  "                </div>",
  ...
  "              <div class=\"log-line\">",
  "                <span class=\"log-ts\">[--:--:--]</span> <span class=\"log-component\">SYSTEM:</span>",
