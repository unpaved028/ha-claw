...
const TEMPLATE_LINES: string[] = [
  ...
  "                Automationslücken, Namensvorschläge und aktuelle Leistung — ein Bericht, keine",
  "                drei Tasks. Der Wochenbericht geht sonntags um 10:00 per Telegram, wenn der Bot",
  "                eingerichtet ist.",
  "              </div>",
  ...
  "    'care.intro':",
  "      'Automationslücken, Namensvorschläge und aktuelle Leistung — ein Bericht, keine drei Tasks. Der Wochenbericht geht sonntags um 10:00 an die Kanäle, die unter Settings → Benachrichtigungen angehakt sind.',",
  ...
  "    'care.reload': 'Reload',",
  "    'care.intro':",
  "      'Automation gaps, name proposals and live power — one report, not three tasks. The weekly digest goes out Sunday 10:00 on the channels ticked under Settings → Notifications.',",
