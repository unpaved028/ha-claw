...
const TEMPLATE_LINES: string[] = [
  ...
  "                Dauerzustaende und keine Verbesserungsvorschlaege &ndash; sie stehen deshalb hier",
  "                und nicht unter Tasks. Geraete werden physisch gezaehlt, nicht jede Entity.",
