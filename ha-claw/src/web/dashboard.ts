...
const TEMPLATE_LINES: string[] = [
  ...
  "                <button class=\"backlog-add-btn\" onclick=\"loadSystemHealth()\">",
  "                  <svg",
  "                    width=\"14\"",
  "                    height=\"14\"",
  "                    viewBox=\"0 0 24 24\"",
  ...
  "                Assistant. Telegram meldet sich nur, wenn sich ein Wert verschlechtert.",
  "              </div>",
  "",
  "              <div class=\"health-list\" id=\"health-list\">",
  "                <div class=\"backlog-empty\">Lade System Health...</div>",
  "              </div>",
  "            </div>",
  "",
  "            <!-- Tasks -->",
